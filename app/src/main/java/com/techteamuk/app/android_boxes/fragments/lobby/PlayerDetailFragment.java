package com.techteamuk.app.android_boxes.fragments.lobby;
...
public class PlayerDetailFragment extends Fragment implements View.OnClickListener, ServiceConnection {
...
//        getActivity().unregisterReceiver(this.broadcastReceiver);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View result=inflater.inflate(R.layout.player_detail_frag, container, false);
    ...
    public void updatePlayerDetails(int resourceID){
        TextView textView = (TextView)getView().findViewById(R.id.player_detail_name);
